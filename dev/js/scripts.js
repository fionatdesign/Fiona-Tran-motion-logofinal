...
function cherryBranch(){
    ...
    .from("#leaf", {duration:1, yoyo: true, rotate: 5, repeat: 3}, "animate+=1.3")
    .from("#cherrybranch", {duration:1, yoyo: true, transformOrigin: "130px 10px", rotate: 5, repeat: 3}, "animate+=1.3")
    .to("#branch", {duration:1, y:-400}, "animate+=4.5")
    .to("#leaf", {duration:1, y:-500}, "animate+=4.5")
    .to("#cherrybranch", {duration:1, y:200, rotate: 25, transformOrigin: "bottom center", ease: "bounce.out"}, "animate+=4.5")
    .to("#cherrybranch", {duration:1, rotate: -100, transformOrigin: "bottom center", ease: "back.out(1.8)"}, "animate+=5")
    .to("#cherrybranch", {duration:1, rotate: 0, transformOrigin: "bottom center", x:10, ease: "back.out(3)"}, "animate+=5")
    .to("#cherrystem", {duration:1, rotate: 30, x:-10, transformOrigin: "bottom", ease: "back.out(3)"}, "animate+=5")
...
function logoName(){
    ...
    .from(".dot", {opacity: 0, transformOrigin: "center", scale: 2, delay: 1, ease: "power3.out", duration: 0.5})
